...
> **Note:** The source code is now open-source and available in this repository, alongside the project motivation, system design, methodology, and results. (Model weights and patient speech data are not included, for privacy and size — see `.gitignore`.)
